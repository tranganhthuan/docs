...
Công thức trên được áp dụng vào phân loại email có spam hay không khi email có từ W. Ví dụ, người ta đếm tỉ lệ email spam trên tổng số email là 0,7 và tỉ lệ email có từ "free" là 0,3. Sau đó, trong tập email spam tỉ lệ email có chữ "free" là 0,4. Từ những dữ liệu trên ta có thể tính được xác suất để email là spam khi nó có chứa chữ "free".

...
| Điều kiện | Công thức |
|:-:|:-:|
| Biết $$\sigma^2$$ | $$\sigma_1^2 = \frac{\sum_{i = 1}^n (X_i - \mu)^2}{\chi_{\alpha/2}^2(n)}$$ <br/> $$\sigma_1^2 = \frac{\sum_{i = 1}^n (X_i - \mu)^2}{\chi_{1- \alpha/2}^2(n)}$$|
| Không biết $$\sigma^2$$ | $$\sigma_1^2 = \frac{(n - 1)s^2}{\chi_{\alpha/2}^2(n)}$$ <br/> $$\sigma_1^2 = \frac{(n - 1)s^2}{\chi_{\alpha/2}^2(n)}$$ |

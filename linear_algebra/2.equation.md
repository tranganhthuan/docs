...
Hệ phương trình của hai mặt phẳng:
...
| Trùng nhau (Coincidence) | - $$\vec{u}$$ song song $$\vec{v}$$ - $$B$$ thuộc $$P_1$$ hoặc $$A$$ thuộc $$P_2$$  |
| Song song (Parallel) | - $$\vec{u}$$ song song $$\vec{v}$$  - $$B$$ không thuộc $$P_1$$ hoặc $$A$$ không thuộc $$P_2$$  |

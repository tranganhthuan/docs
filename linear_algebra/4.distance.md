...
- Do 2 đường thẳng song song nên chúng cùng một mặt phẳng. Nên véc tơ $$\vec{AB}$$ và véc tơ $$\vec{v}$$ sẽ tạo thành hình tam giác.

- Khoảng cách giữa đường thẳng $$L_1$$ với đường thẳng $$L_2$$ chính bằng đường cao của tam giác này:

$$d(L_1,L_2) = \frac{|[\vec{AB}\vec{v}]|}{|\vec{v}|}$$ 

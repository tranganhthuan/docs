...
- Độ lớn tích có hướng của hai véc tơ $$\vec{u}$$, $$\vec{v}$$ bằng độ lớn của hình bình hành tạo bơi hai véc tơ này.

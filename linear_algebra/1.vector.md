...
Gọi $$v'$$ là hình chiếu của $$v$$ lên $$u$$ ($$u' = u*cos(alpha)$$), ta có tích vô hướng của 2 véc tơ u , v là tích giữa độ dài của véc tơ v' và độ dài của vec tơ u.  

$$\vec{u}, \vec{v} = \|\vec{u}\| * \|\vec{v}\| * cos(\alpha)$$

**Cách tính:**

Tích vô hương của 2 véc tơ $$\vec{u}, \vec{v}$$ được tính bằng công thức:

$$\vec{u}.\vec{v} = \begin{bmatrix} u_1 & u_2 & ... & u_n \end{bmatrix} . \begin{bmatrix} v_1 & v_2 & ... & v_n \end{bmatrix} = \sum_{i=1}^n u_i * v_i$$

**Ý nghĩa:**

Tích vô hướng thể hiện độ giống nhau của 2 véc tơ.
